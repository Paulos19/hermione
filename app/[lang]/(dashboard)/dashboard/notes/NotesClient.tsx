          ...
          <main className="flex-1 overflow-y-auto relative">
            <div className="max-w-[1600px] mx-auto px-4 sm:px-8 md:px-12 py-6 md:py-10 space-y-6 md:space-y-10 pb-32">
              ...
              <section className="relative overflow-hidden rounded-[24px] bg-white dark:bg-[#10151B] border border-gray-200 dark:border-white/10 shadow-sm">
                <div className="absolute top-0 right-0 -translate-y-12 translate-x-12 w-64 h-64 bg-amber-500/10 dark:bg-amber-400/10 rounded-full blur-3xl pointer-events-none" />
              ...
              <section className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="relative w-full sm:max-w-md">
                  ...
                  <input
                    ...
                    className="w-full bg-white dark:bg-[#141A22] border border-gray-200 dark:border-white/5 rounded-xl pl-10 pr-4 py-2.5 text-[14px] text-gray-900 dark:text-[#F5F5F5] placeholder:text-gray-500 focus:outline-none focus:border-amber-500/50 transition-colors shadow-sm"
                  />
                </div>
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                  <select 
                    ...
                    className="w-full sm:w-auto px-4 py-2.5 bg-white dark:bg-[#141A22] border border-gray-200 dark:border-white/5 rounded-xl text-[14px] font-medium text-gray-700 dark:text-[#F5F5F5] focus:outline-none focus:border-amber-500 shadow-sm"
                  >
                ...
                {filteredNotes.length > 0 ? (
                    ...
                    {filteredNotes.map(note => (
                      ...
                      >
                        ...
                        <div className="flex justify-between items-start pr-4">
                          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-amber-50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400 rounded-md text-[10px] font-bold uppercase tracking-wider mb-2">
                        ...
                        <div className="flex-1">
                          <p className="text-[14px] text-gray-600 dark:text-[#8A94A0] line-clamp-5 leading-relaxed font-mono">
                            {note.content || "Vazio..."}
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="py-24 border border-gray-200 dark:border-white/5 border-dashed rounded-[24px] bg-white dark:bg-[#141A22]/50 flex flex-col items-center justify-center text-center shadow-sm">
                    <div className="w-16 h-16 bg-gray-50 dark:bg-[#10151B] rounded-2xl flex items-center justify-center mb-6 border border-gray-200 dark:border-white/5">
                      <PenTool className="w-8 h-8 text-gray-400 dark:text-[#8A94A0]" />
                    </div>
                    <h3 className="text-[20px] font-medium text-gray-900 dark:text-white mb-2">Nenhum rascunho salvo</h3>
                  ...
                  <form onSubmit={handleSave} className="flex-1 overflow-y-auto p-6 flex flex-col gap-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div className="flex flex-col gap-1.5">
                        ...
                        <input
                          ...
                          className="w-full bg-gray-50 dark:bg-[#10151B] border border-gray-200 dark:border-white/5 rounded-xl px-4 py-2.5 text-[14px] text-gray-900 dark:text-[#F5F5F5] focus:outline-none focus:border-amber-500"
                        />
                      </div>
                    ...
                    <div className="flex flex-col gap-1.5 h-full">
                      ...
                      <textarea
                        ...
                        className="w-full flex-1 min-h-[220px] bg-gray-50 dark:bg-[#10151B] border border-gray-200 dark:border-white/5 rounded-xl px-4 py-3 text-[14px] text-gray-900 dark:text-[#F5F5F5] focus:outline-none focus:border-amber-500 resize-none leading-relaxed font-mono"
                      />
                    </div>
