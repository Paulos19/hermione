...
export default function DashboardClient({ books: initialBooks, userName, wordsToday, recentActivity, lang }: DashboardProps) {
  ...
  return (
    <div className={`${theme === 'dark' ? 'dark' : ''} antialiased`}>
      <div className="flex h-screen w-full font-sans bg-gray-50 dark:bg-[#0A0D12] text-gray-900 dark:text-[#F5F5F5] overflow-hidden transition-colors duration-200">
        ...
        {/* Fixed Sidebar */}
        <DashboardSidebar wordsToday={wordsToday} lang={lang} />
              ...
              <section className="xl:col-span-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    { title: t.chatHermione, desc: t.chatHermioneDesc, icon: MessageSquare, action: () => {}, color: "text-gray-900 dark:text-[#F5F5F5]" },
